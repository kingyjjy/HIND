  ...
  return (
    <>
        ...
        <div className="container">
            <hr />
            <div className='border shadow-lg  mx-auto mb-3 px-4' style={{width:'500px', height:'600px', marginTop:'100px', borderRadius:'20px'}}>
            <div className="text-end mt-3"><Link to='/' className="btn btn-close"></Link></div>
                <div className="text-center p-5" style={{marginTop:'20px'}}>
                    ...
                    <Link to='/login' className='notlogbtn btn btn-primary mt-5'>로그인 하기</Link>
                </div>
            </div>
        </div>
        <Footer/>
